...
#line 2 "..\\Nokia1616\\Nokia1616.c"


#line 33 "..\\Nokia1616\\Nokia1616.c"
	...
	void USART1_send (uint16_t data)
		{
		uint32_t temp;
		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BSRR = ((uint32_t)0x00200000);;
		temp = __rbit (data) >> 23;
		while (!(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->SR & ((uint16_t)0x0080)))
			{};
		((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR = temp;
		((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BSRR = ((uint32_t)0x00200000);;
		}
...
void LCD_NOKIA1616_init (void)
	...
	{USART1_send((0x38));};;                
	{USART1_send((0xB0));};;
 	{USART1_send(0x100 | (0x0010));};;        
  	{USART1_send((0x36));};;
 	{USART1_send(0x100 | (0x00F8));};;            
	{USART1_send((0x3A));};;
	{USART1_send(0x100 | (0x105));};;        
    {USART1_send((0x29));};;
	}


void LCD_NOKIA1616_set_rectangle_range (uint8_t first_str, uint8_t last_str, uint8_t first_col, uint8_t last_col)
	{
	{USART1_send((0x2A));};;
	{USART1_send(0x100 | (first_str >> 8));};;
	{USART1_send(0x100 | (first_str));};;
	{USART1_send(0x100 | (last_str >> 8));};;
	{USART1_send(0x100 | (last_str));};;
	{USART1_send((0x2B));};;
	{USART1_send(0x100 | (first_col >> 8));};;
	{USART1_send(0x100 | (first_col));};;
	{USART1_send(0x100 | (last_col >> 8));};;
	{USART1_send(0x100 | (last_col));};;
	{USART1_send((0x2C));};;
	}
...
void LCD_NOKIA1616_rectangle (uint8_t first_str, uint8_t last_str, uint8_t first_col, uint8_t last_col, uint32_t color )
	{	
	uint16_t k, lcd_color;				  
	lcd_color =  LCD_NOKIA1616_transform_color (color);
	LCD_NOKIA1616_set_rectangle_range (first_str, last_str, first_col, last_col);

	for ( k = 1; k < (last_str - first_str +1)*(last_col - first_col +1)+ 1; k++)
		{
		{USART1_send(0x100 | (lcd_color>>8));};;
		{USART1_send(0x100 | (lcd_color));};;
		}
	  }

#line 1 "..\\Nokia1616\\icons8x8.c"
#line 2 "..\\Nokia1616\\icons8x8.c"

#line 27 "..\\Nokia1616\\icons8x8.c"


	const uint8_t icons8x8[] = {
		, 
		};
#line 114 "..\\Nokia1616\\Nokia1616.c"
	void LCD_NOKIA1616_print_icon8x8 (uint8_t icon_ID ,uint16_t x, uint16_t y, uint32_t backgnd_color, uint32_t icon_color)
		{
		uint16_t  color;
		uint8_t i,j;
		uint16_t bk_color 	=  	LCD_NOKIA1616_transform_color (backgnd_color);
		uint16_t ic_color 	= 	LCD_NOKIA1616_transform_color (ic_color);
						  
		LCD_NOKIA1616_set_rectangle_range (x, x+7, y, y+7);
		...
		for ( i = 0; i <8; i++)
			...
			for (j = 0; j < 8; j++)
				...
				{USART1_send(0x100 | (color >> 8));};;
				{USART1_send(0x100 | (color));};;
				}
			}
		} 


#line 1 "..\\Nokia1616\\font5x8.c"





#line 7 "..\\Nokia1616\\font5x8.c"
#line 8 "..\\Nokia1616\\font5x8.c"
...
const uint8_t font5x8pxCharBitmaps[] = {
	...
	, 	 
	...
	, 	 
	...
	0xFE, 0x92, 0x92, 0x92, 0x82, 	 
	0xE6, 0x18, 0xFE, 0x18, 0xE6, 	 
	0x44, 0x82, 0x92, 0x92, 0x6C, 	 
	0xFE, 0x08, 0x10, 0x20, 0xFE, 	 
	0xFE, 0x08, 0x90, 0x20, 0xFE, 	 
	0xFE, 0x10, 0x28, 0x44, 0x82, 	 
	0x02, 0x7C, 0x80, 0x80, 0x7E, 	 
	0xFE, 0x40, 0x20, 0x40, 0xFE, 	 
	0xFE, 0x10, 0x10, 0x10, 0xFE, 	 
	0x7C, 0x82, 0x82, 0x82, 0x7C, 	 
	...
	0x78, 0x84, 0xFE, 0x84, 0x78, 	 
	0xC6, 0x28, 0x10, 0x28, 0xC6, 	 
	0xFC, 0x04, 0x04, 0xFC, 0x02, 	 
	0xF8, 0x08, 0x08, 0x08, 0xFE, 	 
	0xFE, 0x02, 0xFE, 0x02, 0xFE, 	 
	0xFC, 0x04, 0xFC, 0x04, 0xFE, 	 
	0x80, 0xFE, 0x22, 0x22, 0x1C, 	 
	0xFE, 0x22, 0x3E, 0x00, 0xFE, 	 
	0xFE, 0x22, 0x22, 0x22, 0x1C, 	 
	0x44, 0x82, 0x92, 0x92, 0x7C, 	 
	0xFE, 0x10, 0xFE, 0x82, 0xFE, 	 
	0x62, 0x94, 0x98, 0x90, 0xFE, 	 
	0x04, 0x2A, 0x2A, 0x2A, 0x1E, 	 
	0x3C, 0x52, 0x52, 0xD2, 0x0C, 	 
	0x3E, 0x2A, 0x2A, 0x1A, 0x04, 	 
	0x3E, 0x20, 0x20, 0x20, 0x20, 	 
	0x06, 0x1C, 0x24, 0x3C, 0x06, 	 
	0x1C, 0x2A, 0x2A, 0x2A, 0x18, 	 
	0x2E, 0x10, 0x3E, 0x10, 0x2E, 	 
	0x14, 0x22, 0x2A, 0x2A, 0x14, 	 
	0x3E, 0x04, 0x08, 0x10, 0x3E, 	 
	0x3E, 0x84, 0x48, 0x90, 0x3E, 	 
	0x3E, 0x08, 0x08, 0x14, 0x22, 	 
	0x02, 0x1E, 0x20, 0x20, 0x3E, 	 
	...
	0x22, 0x14, 0x08, 0x14, 0x22, 	 
	0x3C, 0x04, 0x04, 0x3C, 0x02, 	 
	0x38, 0x04, 0x04, 0x04, 0x3E, 	 
	0x3E, 0x02, 0x3E, 0x02, 0x3E, 	 
	0x3C, 0x04, 0x3C, 0x04, 0x3E, 	 
	0x20, 0x3E, 0x12, 0x12, 0x0C, 	 
	0x3E, 0x12, 0x12, 0x0C, 0x3E, 	 
	0x3E, 0x12, 0x12, 0x12, 0x0C, 	 
	0x14, 0x22, 0x2A, 0x2A, 0x1C, 	 
	0x3E, 0x1C, 0x22, 0x22, 0x1C, 	 
...
const FONT_INFO font5x8pxFontInfo =
{
	...
	255,	
	0x01 | 0x02,	
	((const FONT_CHAR_INFO *)(5)),	
	font5x8pxCharBitmaps,	
};
#line 146 "..\\Nokia1616\\Nokia1616.c"
	...
	uint32_t  Font_bkgnd_color, Font_color;
...
#line 179 "..\\Nokia1616\\Nokia1616.c"
			default:	font = 0;
			}
		}
	...
	uint8_t LCD_NOKIA1616_GetCharWidth(char c)
		...
		return (font->u8Flags & 0x01 ? ((int)font->asFontCharInfo)&0x0FF : font->asFontCharInfo[(c) - font->u8FirstChar]. width);
		}
	...
	uint16_t LCD_NOKIA1616_GetStringWidth(const char* str)
		...
		while(*str) {	
			if(w) len += (font->u8Flags & 0x01 ? 1 : 2);
	...
	uint8_t LCD_NOKIA1616_DrawChar(int16_t x, int16_t y, uint8_t c)
		{
		uint8_t width = (font->u8Flags & 0x01 ? ((int)font->asFontCharInfo)&0x0FF : font->asFontCharInfo[(c) - font->u8FirstChar]. width);
		...
		const uint8_t *ptr = (&font->au8FontTable[font->u8Flags & 0x01 ? (c - font->u8FirstChar)*(((int)font->asFontCharInfo)&0x0FF) : font->asFontCharInfo[c - font->u8FirstChar]. start]);
		if(!font) return 0;
		if(c < font->u8FirstChar || c > font->u8LastChar) return 0;

		LCD_NOKIA1616_set_rectangle_range (x,x+height-1,y,y+width-1);
		...
		for(i = 0; i < height; i++) 
			...
			for(j = 0; j < width; j++) 
				...
				{USART1_send(0x100 | (((mask & 0x80) ? Ft_color : Ft_bkgnd_color) >>8));};;
				{USART1_send(0x100 | (((mask & 0x80) ? Ft_color : Ft_bkgnd_color)));};;
				mask<<=1;
				k++;
				}
			if(!(font->u8Flags & 0x02) ) k = 0;
			}
		return width;
	}
					   
uint16_t LCD_NOKIA1616_DrawString(int16_t x, int16_t y, const char *str)
{
	int16_t remx = x;
	uint8_t w = 0;
	uint8_t height = font->u8Height;
	...
	while(*str) 
		{
			...
			w = LCD_NOKIA1616_DrawChar(x, y, *str);
			
			LCD_NOKIA1616_rectangle (x,x+height-1,y+w,y+w+(font->u8Flags & 0x01 ? 1 : 2)-1,Font_bkgnd_color);
			
			y += (font->u8Flags & 0x01 ? 1 : 2);
