#ifndef 	Bipolar_st_motor_H_
#define 	Bipolar_st_motor_H_
...
extern void 	bipolar_normal_mode_step_forward (uint32_t delay_time_ms);
extern void 	bipolar_normal_mode_step_reverse (uint32_t delay_time_ms);
extern void 	bipolar_half_mode_step_forward (uint32_t delay_time_ms);
extern void 	bipolar_half_mode_step_reverse (uint32_t delay_time_ms);
//extern void 	wave_mode_step_forward (uint32_t delay_time_ms);
//extern void 	wave_mode_step_reverse (uint32_t delay_time_ms);
extern void 	bipolar_all_phases_off (void);
